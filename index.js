...
const OWNER_ID = 8278472040; 
const REQUIRED_CHANNEL = '@Amourstentia'; 
...
function showWelcomeBanner() {
 ...
 ▀▀▀▀ ▀─▀ ▀▀▀▀ ▀▀▀▀ ▀─▀ ▀▀▀▀ ▀─▀▀ 
 ───────────────────────────────────${reset}`);
    console.log(`${cyan}${bold} WELCOME OWNER AMOURSTENTIA STORE - WINDOWS LOCAL SYSTEM${reset}`);
...
function logToPanel(type, data) {
    ...
    if (type === 'SATUAN') {
        ...
        console.log(`${magenta}${bold}└── [AMOURSTENTIA LOG TRACKER SYSTEM] ──────────────────────────┘${reset}\n`);
    } else if (type === 'BULK') {
        ...
        console.log(`${cyan}${bold}└── [AMOURSTENTIA LOG TRACKER SYSTEM] ──────────────────────────┘${reset}\n`);
    }
}
...
bot.start(async (ctx) => {
    ...
    const welcomeText = 
        `<b>[ AMOURSTENTIA ENTERPRISE - CONTROL PANEL ]</b>\n` +
        `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        `English🇬🇧:\n<i>welcome to bot for hit netflix crack automatically, developed by @Amourstentia. Please utilize this utility responsibly and adhere to system regulations to prevent stability issues.</i>\n\nIndoensian🇮🇩\n<i>Selamat datang di bot untuk mendapatkan crack Netflix secara otomatis, yang dikembangkan oleh @Amourstentia. Harap gunakan utilitas ini secara bertanggung jawab dan patuhi peraturan sistem untuk mencegah masalah stabilitas..</i>\n\n` +
        `<blockquote>` +
...
bot.command('hit', async (ctx) => {
    ...
    // 👉 BATASAN MAKSIMAL 10 UNTUK SEMUA ORANG (TERMASUK OWNER)
    if (targetTotal === 0 || targetTotal > 10) {
        targetTotal = 10;
        ctx.reply('⚠️ *INFO SISTEM:*\nPermintaan disesuaikan menjadi maksimal *10 link* per eksekusi untuk menjaga performa bot.', { parse_mode: 'Markdown' });
    }
...
async function processNextHit() {
    ...
    try {
        ...
        const layoutInit = `<b>[ AMOURSTENTIA ENTERPRISE - INITIALIZATION CORE ]</b>\n` +
                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        ...
        while (akunDicoba < accounts.length) {
            ...
            const layoutLogin = `<b>[ AMOURSTENTIA ENTERPRISE - AUTHENTICATION MODULE ]</b>\n` +
                                `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
            ...
            try {
                ...
                while (shouldContinue) {
                    ...
                    const layoutScraping = `<b>[ AMOURSTENTIA ENTERPRISE - EXTRACTION ENGINE ]</b>\n` +
                                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        ...
        const resultText = `<b>[ AMOURSTENTIA ENTERPRISE - TASK EXECUTION COMPLETED ]</b>\n` +
                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        ...
        if (allResults.length > 0) {
            ...
            await ctx.replyWithDocument(
                ...
                { 
                    caption: `<b>[ AMOURSTENTIA ENTERPRISE - RESULT SUMMARY ]</b>\n` +
                             `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        ...
        try {
            ...
            if (userCurrentMode === 'LINK_TO_COOKIES') {
                const resultText = `✅ successfully logged in and got account cookies!\n\n` +
                                   ...
                                   `Thank you for using this bot, don't forget to follow @Amourstentia`;
...
bot.action('btn_leaderboard', async (ctx) => {
    ...
    let textLeaderboard = `<b>🏆 TOP 10 RANKING CONVERTER AMOURSTENTIA STORE</b>\n─────────────────────────────\n`;
